"""Input handling for N-body simulation keyboard and mouse events."""
...
class NBodyInputHandler:
    """Handles keyboard and mouse input for camera control in N-body sim."""
